...
const CLASS_ANIMA_ATTRIBUTES = require("./anima_attributes.js");
...
function Character(char_name, weapon)
{
  ...
  var _defence = null;
  var _weapon = weapon;
  var _attributes = CLASS_ANIMA_ATTRIBUTES.new(5,5,5,5,5,5,5,5);
  ...
  this.getFinalDamageScore = (weapon) => ANIMA_FORMULAS.getFinalDamageScore(this.attributes.strength_score, weapon.damage);
}
